		...
		<div class="grid-x grid-padding-x grid-margin-x font12">
			...
			<fieldset class="cell medium-6 fieldset" ng-init="mygrupo = {}">
				...
				<div>
					...
					<input type="text" ng-model="mygrupo.nombre_grupo" ng-change="mygrupo.nombre_grupo = toLower(mygrupo.nombre_grupo)" placeholder="ingresa una agrupación de items">
			...
			<fieldset class="cell medium-6 fieldset" ng-init="myclasificacion = {}">
				...
				<div>
					...
					<input type="text" ng-model="myclasificacion.nombre_clasificacion" ng-change="myclasificacion.nombre_clasificacion = toLower(myclasificacion.nombre_clasificacion)" placeholder="ingresa una clasificación de items">
					<button class="button success" ng-click="addGrupo(myclasificacion, proyecto, 'lista_clasificacion_apu', '<?= site_url('proyecto/save') ?>'); myclasificacion={}">Add.</button>
				</div>
